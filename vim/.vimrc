...
command! -nargs=*  FZFDefault :call fzf#run({'source': 'rg --hidden -l --ignore-file "/Users/adam/.vimfzfignore" ""', 'sink': 'e'})
...
command! -range CamelCase silent! call <SID>Camelize(<range>) command! -range SnakeCase silent! call <SID>Snakeize(<range>)
