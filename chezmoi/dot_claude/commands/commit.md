...
**Examples:**
- `feat(design): add editorial sidebar navigation`
- `fix(brand-guide): correct dark mode color contrast`
- `refactor(tokens): consolidate color scale definitions`
- `docs(plans): add navigation redesign plan`

## Branch Naming

Use type prefix matching commit convention: `<type>/<description>`

**Examples:** `feat/nav-redesign`, `fix/dark-mode-contrast`, `refactor/color-tokens`
